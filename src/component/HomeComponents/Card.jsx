...
const Card = ({ product, onOpenPopup }) => {
  ...
  return (
    <div className="bg-[#40342F] rounded-xl p-3 sm:p-4 w-full h-auto sm:h-[225px] flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4 shadow-md relative">
      ...
      <div className="flex-shrink-0 flex justify-center items-center w-full sm:w-[140px] h-[120px] sm:h-[180px] relative">
        <img
          ...
          onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/140x180/cccccc/000000?text=Image+Not+Found"; }}
        />
      </div>
      ...
      <div className="flex flex-col justify-between flex-1 w-full h-full py-1 sm:py-2">
        ...
        <div className="absolute top-2 right-2 sm:top-3 sm:right-3 flex flex-col gap-2 z-10">
          ...
          {/* Eye icon now triggers the popup */}
          <button
